...
def dnn_18(num_classes=10, tiny=False, name="preresnet_dnn_18", **block_kwargs):
    return resnet.ResNet(preresnet_dnn.BasicBlock, [2, 2, 2, 2],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def dnn_34(num_classes=10, tiny=False, name="preresnet_dnn_34", **block_kwargs):
    return resnet.ResNet(preresnet_dnn.BasicBlock, [3, 4, 6, 3],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def dnn_50(num_classes=10, tiny=False, name="preresnet_dnn_50", **block_kwargs):
    return resnet.ResNet(preresnet_dnn.Bottleneck, [3, 4, 6, 3],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def dnn_101(num_classes=10, tiny=False, name="preresnet_dnn_101", **block_kwargs):
    return resnet.ResNet(preresnet_dnn.Bottleneck, [3, 4, 23, 3],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def dnn_152(num_classes=10, tiny=False, name="preresnet_dnn_152", **block_kwargs):
...
def mcdo_18(num_classes=10, tiny=False, name="preresnet_mcdo_18", **block_kwargs):
    return resnet.ResNet(preresnet_mcdo.BasicBlock, [2, 2, 2, 2],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def mcdo_34(num_classes=10, tiny=False, name="preresnet_mcdo_34", **block_kwargs):
    return resnet.ResNet(preresnet_mcdo.BasicBlock, [3, 4, 6, 3],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def mcdo_50(num_classes=10, tiny=False, name="preresnet_mcdo_50", **block_kwargs):
    return resnet.ResNet(preresnet_mcdo.Bottleneck, [3, 4, 6, 3],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def mcdo_101(num_classes=10, tiny=False, name="preresnet_mcdo_101", **block_kwargs):
    return resnet.ResNet(preresnet_mcdo.Bottleneck, [3, 4, 23, 3],
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def mcdo_152(num_classes=10, tiny=False, name="preresnet_mcdo_152", **block_kwargs):
