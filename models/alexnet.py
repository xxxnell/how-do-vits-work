...
def dnn(num_classes=10, tiny=False, name="alexnet_dnn", **block_kwargs):
    return AlexNet(alexnet_dnn.BasicBlock, num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)
...
def dnn_smooth(num_classes=10, tiny=False, name="alexnet_dnn_smoothing", **block_kwargs):
    return AlexNet(alexnet_dnn.BasicBlock,
                   sblock=smoothing.SigmoidBlurBlock, num_sblocks=[1, 1, 1],
