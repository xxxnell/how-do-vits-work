...
def dnn_50(num_classes=10, tiny=False, name="wideresnet_dnn_50", **block_kwargs):
    return resnet.ResNet(resnet_dnn.Bottleneck, [3, 4, 6, 3],
                         width_per_group=64 * 2,
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def dnn_101(num_classes=10, tiny=False, name="wideresnet_dnn_101", **block_kwargs):
...
def mcdo_50(num_classes=10, tiny=False, name="wideresnet_mcdo_50", **block_kwargs):
    return resnet.ResNet(resnet_mcdo.Bottleneck, [3, 4, 6, 3],
                         width_per_group=64 * 2,
                         num_classes=num_classes, tiny=tiny, name=name, **block_kwargs)


def mcdo_101(num_classes=10, tiny=False, name="wideresnet_mcdo_101", **block_kwargs):
